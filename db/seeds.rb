...
step1 = Step.create!(position: 1, title: "BILAN PROFESSIONNEL", background: "")
step2 = Step.create!(position: 2, title: "VALIDATION PROJET PROFESSIONNEL", background: "")
step3 = Step.create!(position: 3, title: "CHOIX FORMATION & FINANCEMENT", background: "")
step4 = Step.create!(position: 4, title: "INSCRIPTION FORMATION & SELECTION CANDIDAT", background: "")
step5 = Step.create!(position: 5, title: "INTEGRATION & SUIVI DE FORMATION", background: "")
step6 = Step.create!(position: 6, title: "RECHERCHES OPPORTUNITÉS PRO POST FORMATION", background: "")
step7 = Step.create!(position: 7, title: "INTEGRATION EN ENTREPRISE & FORMATION CONTINUE", background: "")
